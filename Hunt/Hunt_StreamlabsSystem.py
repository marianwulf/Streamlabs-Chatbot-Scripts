...
class Settings:
    ...
    def __init__(self, settingsFile=None):
        ...
        if settingsFile and os.path.isfile(settingsFile):
            ...
            self.B1WinText = "$username and his/her $attendees crewmates have won $points $currency! So everybody won $attendeepoints $currency."
            ...
            self.B2WinText = "$username and his/her $attendees crewmates have won $points $currency! So everybody won $attendeepoints $currency."
            ...
            self.B3WinText = "$username and his/her $attendees crewmates have won $points $currency! So everybody won $attendeepoints $currency."
            ...
            self.B4WinText = "$username and his/her $attendees crewmates have won $points $currency! So everybody won $attendeepoints $currency."
            ...
            self.B5WinText = "$username and his/her $attendees crewmates have won $points $currency! So everybody won $attendeepoints $currency."
        ...
        if not MySet.OnlyLive or Parent.IsLive():
            ...
            if MySet.ActiveGame:
                ...
                if MySet.selectedboss == 0:
                    MySet.Boss[5] = MySet.B1WinText.replace("$username", MySet.BossStarterUserName).replace("$attendees", str(len(MySet.ActiveGameAttendees)-1)).replace("$points", str(MySet.Boss[2])).replace("$currency", Parent.GetCurrencyName()).replace("$attendeepoints", str(MySet.Boss[2]/len(MySet.ActiveGameAttendees)))
                elif MySet.selectedboss == 1:
                    MySet.Boss[5] = MySet.B2WinText.replace("$username", MySet.BossStarterUserName).replace("$attendees", str(len(MySet.ActiveGameAttendees)-1)).replace("$points", str(MySet.Boss[2])).replace("$currency", Parent.GetCurrencyName()).replace("$attendeepoints", str(MySet.Boss[2]/len(MySet.ActiveGameAttendees)))
                elif MySet.selectedboss == 2:
                    MySet.Boss[5] = MySet.B3WinText.replace("$username", MySet.BossStarterUserName).replace("$attendees", str(len(MySet.ActiveGameAttendees)-1)).replace("$points", str(MySet.Boss[2])).replace("$currency", Parent.GetCurrencyName()).replace("$attendeepoints", str(MySet.Boss[2]/len(MySet.ActiveGameAttendees)))
                elif MySet.selectedboss == 3:
                    MySet.Boss[5] = MySet.B4WinText.replace("$username", MySet.BossStarterUserName).replace("$attendees", str(len(MySet.ActiveGameAttendees)-1)).replace("$points", str(MySet.Boss[2])).replace("$currency", Parent.GetCurrencyName()).replace("$attendeepoints", str(MySet.Boss[2]/len(MySet.ActiveGameAttendees)))
                elif MySet.selectedboss == 4:
                    MySet.Boss[5] = MySet.B5WinText.replace("$username", MySet.BossStarterUserName).replace("$attendees", str(len(MySet.ActiveGameAttendees)-1)).replace("$points", str(MySet.Boss[2])).replace("$currency", Parent.GetCurrencyName()).replace("$attendeepoints", str(MySet.Boss[2]/len(MySet.ActiveGameAttendees)))
